...
public class Ropa {
    ...
    private int codigoVenta; // finalmente no se implementó un código de venta, pero podría hacerse perfectamente.
        ...
        switch(opcionUsuario) {
            ...
            case 7:
                ...
                switch(opcionUsuarioZD) {
                    ...
                    case 6: ropaObjeto = new Ropa();
                            ...
                            ropaObjeto.setPrecioPrenda(129990);
                            //ropaObjeto.setCodigoVenta((int) (Math.random() * 90000));
                            totalYRetornoCompra.add(getPrecioPrenda());
                            System.out.println("Usted está llevando: ");
                            System.out.println("Tipo de Prenda: "+ropaObjeto.getTipoRopa());
                            System.out.println("Marca y Modelo: "+ropaObjeto.getMarcaRopa()+" "+ropaObjeto.getModeloRopa());
            ...
            case 8:
                ...
                if(confirmarCompra == 1) {
                    ...
                    DiscountManager elDescuento = DiscountManager.obtenerInstancia(); // PATRÓN DE DISEÑO SINGLETON
                    elDescuento.realizarDescuento(totalAPagar); // Realizamos una única instancia. Método Singleton.
                    ropa.clear();
