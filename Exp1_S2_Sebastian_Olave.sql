...
CREATE TABLE DETALLE_DE_CLIENTES
   (	
	...
	CORREO_CORP VARCHAR2(100) NOT NULL,
        PERIODO     VARCHAR2(10) NOT NULL
   ) ;


CREATE TABLE TRAMO_EDAD
( SEC_TRAMO_EDAD NUMBER(2) GENERATED  ALWAYS AS IDENTITY MINVALUE 1 
MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOT NULL ENABLE,
  ANNO_VIG NUMBER(4) NOT NULL,
  TRAMO_INF  NUMBER(10) NOT NULL,
  TRAMO_SUP   NUMBER(10) NOT NULL, 
  PORCENTAJE NUMBER(2) NOT NULL,
  CONSTRAINT PK_TRAMO_EDAD PRIMARY KEY (SEC_TRAMO_EDAD,ANNO_VIG));
...
INSERT INTO TRAMO_EDAD(ANNO_VIG,TRAMO_INF,TRAMO_SUP,PORCENTAJE) VALUES((EXTRACT(YEAR FROM SYSDATE)-1),1,9,4);
INSERT INTO TRAMO_EDAD(ANNO_VIG,TRAMO_INF,TRAMO_SUP,PORCENTAJE) VALUES((EXTRACT(YEAR FROM SYSDATE)-1),10,15,6);
INSERT INTO TRAMO_EDAD(ANNO_VIG,TRAMO_INF,TRAMO_SUP,PORCENTAJE) VALUES((EXTRACT(YEAR FROM SYSDATE)-1),16,25,7);
INSERT INTO TRAMO_EDAD(ANNO_VIG,TRAMO_INF,TRAMO_SUP,PORCENTAJE) VALUES((EXTRACT(YEAR FROM SYSDATE)-1),26,40,10);
INSERT INTO TRAMO_EDAD(ANNO_VIG,TRAMO_INF,TRAMO_SUP,PORCENTAJE) VALUES((EXTRACT(YEAR FROM SYSDATE)),1,9,5);
INSERT INTO TRAMO_EDAD(ANNO_VIG,TRAMO_INF,TRAMO_SUP,PORCENTAJE) VALUES((EXTRACT(YEAR FROM SYSDATE)),10,15,7);
INSERT INTO TRAMO_EDAD(ANNO_VIG,TRAMO_INF,TRAMO_SUP,PORCENTAJE) VALUES((EXTRACT(YEAR FROM SYSDATE)),16,25,8);
INSERT INTO TRAMO_EDAD(ANNO_VIG,TRAMO_INF,TRAMO_SUP,PORCENTAJE) VALUES((EXTRACT(YEAR FROM SYSDATE)),26,10000,11);
...
INSERT INTO  TRAMO_ANTIGUEDAD  (ANNO_VIG,TRAMO_INF,TRAMO_SUP,PORCENTAJE)   VALUES((EXTRACT(YEAR FROM SYSDATE)),26,10000,11);
...
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'�u�oa');
...
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'Maip�');
...
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'Pe�alol�n');
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'Puente Alto');
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'Recoleta');
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'Estaci�n Central');
...
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'Conchal�');
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'San Joaqu�n');
...
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'San Ram�n');
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'Melipilla');
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'San Pedro');
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'Alhu�');
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'Mar�a Pinto');
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'Curacav�');
...
INSERT INTO comuna VALUES (SEQ_PROVINCIA.NEXTVAL,'Pe�aflor');
...
INSERT INTO tipo_camion  VALUES ('B','Frigor�fico');
INSERT INTO tipo_camion  VALUES ('C','Cami�n 3/4');
...
INSERT INTO EMPLEADO(numrun_emp,dvrun_emp,appaterno_emp,apmaterno_emp,pnombre_emp,snombre_emp,direccion_emp,sexo,celular_emp,fono_fijo_emp,fecha_nac,fecha_contrato,sueldo_base,id_comuna,cod_tipo_sal,cod_afp,id_estado_civil) VALUES(11846972,'5','OGAZ','VARAS','MARCO','ANTONIO','OVALLE N�5798 V/ OHIGGINS','M',76432652, NULL,'3112' || TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-60),'2208'|| TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-36),325590,118,'F',5,20);
INSERT INTO EMPLEADO(numrun_emp,dvrun_emp,appaterno_emp,apmaterno_emp,pnombre_emp,snombre_emp,direccion_emp,sexo,celular_emp,fono_fijo_emp,fecha_nac,fecha_contrato,sueldo_base,id_comuna,cod_tipo_sal,cod_afp,id_estado_civil) VALUES(14283083,'6','MONDACA','COLLAO','PEDRO','HERNAN','NUEVA COLON N�1152','M',67416145,NULL,'2107' || TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-30),'0108'|| TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-1),1144245,95,'F',5,40);
...
INSERT INTO EMPLEADO(numrun_emp,dvrun_emp,appaterno_emp,apmaterno_emp,pnombre_emp,snombre_emp,direccion_emp,sexo,celular_emp,fono_fijo_emp,fecha_nac,fecha_contrato,sueldo_base,id_comuna,cod_tipo_sal,cod_afp,id_estado_civil) VALUES(12468081,'9','SANCHEZ','GONZALEZ','PAOLA','ANDREA','AV.OSSA 01240 V/MI VI�ITA','F',56832705,'25273328','0401' || TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-32),'2608'|| TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-9),1330355,99,'F',3,20);
INSERT INTO EMPLEADO(numrun_emp,dvrun_emp,appaterno_emp,apmaterno_emp,pnombre_emp,snombre_emp,direccion_emp,sexo,celular_emp,fono_fijo_emp,fecha_nac,fecha_contrato,sueldo_base,id_comuna,cod_tipo_sal,cod_afp,id_estado_civil) VALUES(12260812,'0','RIOS','ZU�IGA','RAFAEL','ALFONSO','LOS CASTA�OS 1427 VILLA C.C.U.','M',96255762,'26410462','2507' || TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-28),'2708'|| TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-8),367056,118,'F',4,40);
INSERT INTO EMPLEADO(numrun_emp,dvrun_emp,appaterno_emp,apmaterno_emp,pnombre_emp,snombre_emp,direccion_emp,sexo,celular_emp,fono_fijo_emp,fecha_nac,fecha_contrato,sueldo_base,id_comuna,cod_tipo_sal,cod_afp,id_estado_civil) VALUES(12899759,'1','CACERES','JIMENEZ','ERIKA',NULL,'PJE.NAVARINO 15758 V/P.DE O�A','F',82936654,NULL,'2308' || TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-51),'2808'|| TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-27),2281415,107,'F',5,30);
...
INSERT INTO EMPLEADO(numrun_emp,dvrun_emp,appaterno_emp,apmaterno_emp,pnombre_emp,snombre_emp,direccion_emp,sexo,celular_emp,fono_fijo_emp,fecha_nac,fecha_contrato,sueldo_base,id_comuna,cod_tipo_sal,cod_afp,id_estado_civil) VALUES(12648200,'3','NARVAEZ','MU�OZ','LUIS','ANTONIO','AMBRIOSO OHIGGINS  2010','M',65351928,NULL,'0807' || TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-26),'3008'|| TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-7),1966613,80,'I',1,20);
...
INSERT INTO EMPLEADO(numrun_emp,dvrun_emp,appaterno_emp,apmaterno_emp,pnombre_emp,snombre_emp,direccion_emp,sexo,celular_emp,fono_fijo_emp,fecha_nac,fecha_contrato,sueldo_base,id_comuna,cod_tipo_sal,cod_afp,id_estado_civil) VALUES(12642309,'K','NAVARRO','SANTIBA�EZ','JUAN','ESTEBAN','SANTA ELENA 300 V/LOS ALAMOS','F',52893123,'27441530','1101' || TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-33),'0111'|| TO_CHAR(EXTRACT(YEAR FROM SYSDATE)-1),1659230,83,'F',5,10);
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('11657132','8','ACU�A','BARRERA','RONNY','ABEL','OBS.ASTRONOMICO UC PAR.METROP.','65296851','27370770','420000','06/03/1969','97','A','40');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('12817700','K','VARGAS','GARAY','CLAUDIA',null,'PJE.BELEN N�8 P/GERALDINE','68111801',null,'400000','28/08/1968','99','A','10');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('14558221','7','PASTEN','JORQUERA','ALAN','MAURICIO','BALMACEDA N�15','96469095','28421196','180000','16/08/1967','108','C','10');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('10586995','1','MU�OZ','FERNANDEZ','JOSE','LUIS','AV.LAS TORRES 152','98725363',null,'1200000','06/03/1968','83','D','20');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('4604866','0','AGUIRRE','MU�OZ','LUIS','ALFONSO','VICHUQUEN 1462','88582729','26238494','300000','06/07/1945','89','A','30');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('12468646','K','ALVAREZ','MU�OZ','MANUEL','EDUARDO','EDUARDO MATTE 2180','67813075','25557973','400000','07/08/1969','80','A','10');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('12189232','8','DELGADO','GALLEGOS','XIMENA','MARGARITA','LUXEMBURGO N�9609','57719055','22202264','340000','02/09/1967','88','A','30');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('12871924','0','VENEGAS','TORRES','JESSICA','RAFAELA','GARCIA REYES N�55C','77735367','26817651','300000','04/09/1970','92','A','40');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('14319321','5','SALVO','GUTIERREZ','PATRICIA','XIMENA','PJE # 1 N�675 P/ANTUPILLAN','92853737','28587242','240000','01/08/1945','99','B','30');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('13050258','0','SALAS','CORNEJO','CARLOS',null,'VALLE DEL SOL N�4028','85450443','22773144','300000','09/09/1977','107','A','20');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('13034352','9','MU�OZ','ASCORRA','CLAUDIA','DELFINA','LOS �ANDUES #509 V/PAJARITOS','65582082','22570673','560000','25/08/1971','87','B','30');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('13083936','7','QUINTANA','MARDONES','RUTH','ANTONIA','PASAJE LA RAIZ N�10591','82936654',null,'180000','28/08/1970','94','C','30');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('12468736','5','GONZALEZ','MU�OZ','OSVALDO','ALEXIS','MARIA LUISA BOMBAL 384','95577263','27414835','340000','09/09/1972','87','A','30');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('11540908','5','BARRERA','RIOS','MARIA','LUISA','PASAJE 36 N�4789 V/EYZAGUIRRE',null,'22097186','160000','26/05/1968','97','C','20');
...
INSERT INTO CLIENTE(numrun_cli,dvrun_cli,appaterno_cli,apmaterno_cli,pnombre_cli,snombre_cli,direccion,celular_cli,fono_fijo_cli,renta,fecha_nac_cli,id_comuna,id_tipo_cli,id_estado_civil) VALUES('10917199','9','ACU�A','OLIVARES','ELIZABETH','FABIOLA','CERRO HUEMUL 1052','96469095','57736141','500000','23/08/1965','107','B','40');
...
VARIABLE PERIODO_SELECCIONADO VARCHAR2(6); -- Variable bind para el periodo seleccionado en formato MMYYYY
EXEC :PERIODO_SELECCIONADO := '032024';    -- Asignamos el valor a la variable bind y la ejecutamos. En este caso, para marzo, el valor es 032024

DECLARE

    REGISTRO_DETALLE DETALLE_DE_CLIENTES%ROWTYPE;  -- ROWTYPE
    
-- Variables auxiliares

    V_PERIODO_ACTUAL VARCHAR2(6) := :PERIODO_SELECCIONADO;
    V_TOTAL_CLIENTES NUMBER;
    V_CLIENTES_PROCESADOS NUMBER := 0;

    CURSOR CURSOR_CLIENTES IS -- Cursor
    
      -- Consulta para obtener los datos de Cliente y Comuna con LEFT JOIN.
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('PROCESANDO CLIENTES...'); -- Salida DBMS de acuerdo a lo solicitado en la figura 2 de las instrucciones
    
    EXECUTE IMMEDIATE 'TRUNCATE TABLE DETALLE_DE_CLIENTES'; -- Truncamos la tabla para eliminar o limpiar datos antiguos innecesarios.

    SELECT COUNT(*) 
      INTO V_TOTAL_CLIENTES 
      FROM CLIENTE;

    -- Gracias al cursor, ahora iteramos sobre los clientes

    FOR REGISTRO_CLIENTE IN CURSOR_CLIENTES LOOP
        REGISTRO_DETALLE.IDC     := REGISTRO_CLIENTE.ID_CLI;
        REGISTRO_DETALLE.RUT     := REGISTRO_CLIENTE.NUMRUN_CLI;
        REGISTRO_DETALLE.CLIENTE := INITCAP(REGISTRO_CLIENTE.APPATERNO_CLI || ' ' || REGISTRO_CLIENTE.APMATERNO_CLI || ' ' || REGISTRO_CLIENTE.PNOMBRE_CLI);
        REGISTRO_DETALLE.EDAD := FLOOR(MONTHS_BETWEEN(SYSDATE, REGISTRO_CLIENTE.FECHA_NAC_CLI) / 12);

        -- Determinamos el puntaje según los requerimientos

        IF REGISTRO_CLIENTE.RENTA > 700000 
           AND REGISTRO_CLIENTE.NOMBRE_COMUNA NOT IN ('LA REINA', 'LAS CONDES', 'VITACURA') 
        THEN
            REGISTRO_DETALLE.PUNTAJE := ROUND(REGISTRO_CLIENTE.RENTA * 0.03);

        ELSIF REGISTRO_CLIENTE.ID_TIPO_CLI IN ('B', 'D') THEN
            REGISTRO_DETALLE.PUNTAJE := REGISTRO_DETALLE.EDAD * 30;
        ELSE
            SELECT PORCENTAJE 
              INTO REGISTRO_DETALLE.PUNTAJE
              FROM TRAMO_EDAD
             WHERE ANNO_VIG = EXTRACT(YEAR FROM SYSDATE)
               AND REGISTRO_DETALLE.EDAD BETWEEN TRAMO_INF AND TRAMO_SUP;
            REGISTRO_DETALLE.PUNTAJE := ROUND(REGISTRO_DETALLE.PUNTAJE * REGISTRO_CLIENTE.RENTA / 100);
        END IF;

        -- Generamos el correo corporativo con terminación en @LogiCarg.cl

        REGISTRO_DETALLE.CORREO_CORP := LOWER(REGISTRO_CLIENTE.APPATERNO_CLI) || REGISTRO_DETALLE.EDAD || '*' || SUBSTR(REGISTRO_CLIENTE.PNOMBRE_CLI, 1, 1) 
                                        || TO_CHAR(REGISTRO_CLIENTE.FECHA_NAC_CLI, 'DD') || TO_NUMBER(SUBSTR(V_PERIODO_ACTUAL, 1, 2)) || '@LogiCarg.cl';

        REGISTRO_DETALLE.PERIODO := SUBSTR(V_PERIODO_ACTUAL, 1, 2) || '/' || SUBSTR(V_PERIODO_ACTUAL, 3);

        INSERT INTO DETALLE_DE_CLIENTES VALUES REGISTRO_DETALLE; -- Insertamos los registros en DETALLE_DE_CLIENTES.
        V_CLIENTES_PROCESADOS := V_CLIENTES_PROCESADOS + 1;
    END LOOP;

    IF V_CLIENTES_PROCESADOS = V_TOTAL_CLIENTES THEN -- Salida en caso de que la condicional sea TRUE
        DBMS_OUTPUT.PUT_LINE('Proceso finalizado exitosamente');
        DBMS_OUTPUT.PUT_LINE('Se procesaron: ' || V_CLIENTES_PROCESADOS);
        COMMIT;
    ELSE
        DBMS_OUTPUT.PUT_LINE('ERROR: NO SE HA PODIDO PROCESAR TODOS LOS CLIENTES. EJECUTANDO ROLLBACK.'); -- Salida en caso de que la condicional sea FALSE
        ROLLBACK;
    END IF;
END;

---------- Consulta para verificar los datos ingresados a la tabla DETALLE_DE_CLIENTES ----------
